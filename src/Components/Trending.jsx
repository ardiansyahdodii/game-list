...
const Trending = ({ gameList }) => {
    ...
    return (
        <div className='mt-5 hidden md:block'>
            ...
            <div className='hodden gap-3 md:grid md:grid-cols-3 lg:grid-cols-4 rounded-lg'>
                {gameList.map((tren, index) => index < 4 && (
                    <div className='bg-slate-400 rounded-lg group hover:scale-110 transition-all ease-in-out duration-300 cursor-pointer'>
